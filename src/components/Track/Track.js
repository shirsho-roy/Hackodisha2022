...
const Track = () => {
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-col text-center w-full mb-20">
      <h1 class="font-medium text-4xl title-font mb-4 tracking-widest text-white"><b>OUR TRACKS</b></h1>
      <p class="lg:w-2/3 mx-auto leading-relaxed text-white-300 text-base"></p>
    </div>
