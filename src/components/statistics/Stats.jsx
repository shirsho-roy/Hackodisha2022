...
function Stats(){
  ...
  <div className='container'>
    ...
    <h1 className='mx-16 py-10 mb-3 text-4xl font-normal'>HackOdisha 1.0 Statistics</h1>
    ...
    <div className='flex flex-col items-center'>   
        ...
        <p className='mb-6 md:mt-3 md:mb-8'>Registrations</p>
    </div>
    <div className='flex flex-col items-center'>
        ...
        <p className='mb-6  md:mt-3 md:mb-8'>Institutions</p>
    </div>
    <div className='flex flex-col items-center'>    
        ...
        <p className='mb-6  md:mt-3 md:mb-8'>Sponsors</p>
    </div>
    <div className='flex flex-col items-center'>
        ...
        <p className='mb-6  md:mt-3 md:mb-8'>Communities</p>
    </div>
    <div className='flex flex-col items-center '>
